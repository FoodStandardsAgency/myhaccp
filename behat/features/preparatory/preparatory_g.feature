...
Feature: Preparatory G
  ...
  Scenario: Test Preparatory G bad image file upload
    Given I select the radio button "No" with the id "edit-preparatory-g-g-1-no"
  ...
  Scenario: Test Preparatory G incompatible PDF file upload
    Given I select the radio button "No" with the id "edit-preparatory-g-g-1-no"
    And I attach the file "pdf_v15_bad.pdf" to "edit-preparatory-g-g-2-upload"
    And I press the "Upload" button
    Then I should see "Remove"
    And I should not see "The PDF uploaded has features incompatible with this system."

  Scenario: Test Preparatory G invalid PDF file upload
    Given I select the radio button "No" with the id "edit-preparatory-g-g-1-no"
    And I attach the file "pdf_invalid.pdf" to "edit-preparatory-g-g-2-upload"
    And I press the "Upload" button
    Then I should not see "Remove"
    And I should see "The file you uploaded does not appear to be a valid PDF file."
