...
Scenario: Complete Principle 1.2 and confirm data entry
    Given I complete all principles up to "1.1"
    And I press the "Save and continue" button
    When I fill row "1" "description" with "A description"
    And I fill row "1" "severity" with "3"
    ...
    Then I should see "A description" in the "tr:nth-of-type(1) td:nth-of-type(2)" element
    And I should see "Stones description" in the "tr:nth-of-type(2) td:nth-of-type(2)" element
    And I should see "Another description" in the "tr:nth-of-type(3) td:nth-of-type(2)" element
    And the "Determine the threshold" field should contain "5"

Scenario: Complete Principle 1.2 and confirm validation errors
    Given I complete all principles up to "1.1"
    And I press the "Save and continue" button
    When I fill row "1" "description" with "A description"
    And I fill row "1" "severity" with "3"
    And I fill row "1" "likelihood" with "3"
    And I fill row "1" "significance" with "9"
    Then I fill in "Determine the threshold" with ""

    And I press the "Save and continue" button

    Then I should see "You have no significant hazards so you cannot continue"
