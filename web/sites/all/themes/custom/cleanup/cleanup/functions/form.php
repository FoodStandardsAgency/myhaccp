...
*/
function cleanup_form_element_label($variables) {
  $element = $variables['element'];
...
*/
function cleanup_textfield($variables) {
  $element = $variables['element'];
  $element['#size'] = '30';
...
function cleanup_checkbox($variables) {
  $element = $variables['element'];
  $t = get_t();
...
function cleanup_file($variables) {
  $element = $variables['element'];
//  $element['#size'] = '30';
...
*/
function cleanup_password($variables) {
  $element = $variables['element'];
  $element['#size'] = '30';
...
/* removed form-select */
function cleanup_select($variables) {
  $element = $variables['element'];
  element_set_attributes($element, array('id', 'name', 'size'));
...
remove form-text class
*/
function cleanup_text_format_wrapper($variables) {
  $element = $variables['element'];
...
function cleanup_button($variables) {
  $element = $variables['element'];
...
remove form-wrapper
*/
function cleanup_fieldset($variables) {
  $element = $variables['element'];
...
function cleanup_container($variables) {
  $element = $variables['element'];
